...
namespace HotelSystem.Data.DataModels
{
    ...
    public partial class db_a784d6_hotelsystemEntities : DbContext
    {
        public db_a784d6_hotelsystemEntities()
            : base("name=db_a784d6_hotelsystemEntities")
        {
        }
        ...
        public virtual DbSet<MultipleRoom> MultipleRooms { get; set; }
        ...
        public virtual ObjectResult<GetLatestUserDetails_Result> GetLatestUserDetails()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetLatestUserDetails_Result>("GetLatestUserDetails");
        }
